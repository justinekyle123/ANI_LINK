...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2025 at 05:54 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('farmer','market','admin') NOT NULL,
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`crop_id`) REFERENCES `crops` (`id`) ON DELETE CASCADE;
